...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'platforms', name: 'Platforms', component: () => import('../views/Platforms.vue'), meta: { title: '平台对接', icon: 'Connection' } },
      { path: 'billing', name: 'Billing', component: () => import('../views/Billing.vue'), meta: { title: '用量计费', icon: 'Coin' } },
      { path: 'expert-review', name: 'ExpertReview', component: () => import('../views/ExpertReview.vue'), meta: { title: '专家审核', icon: 'Edit' } },
